<div class="block">
<?php if (isset($ticketsheader)) { echo "<h3>$ticketsheader</h3>"; } ?>

<?php if (!isset($params) || !is_array($params)) { $params = array(); } ?>
    ...
    <tbody>
      ...
      <?php foreach ($tickets as $ticket) { ?>
        <tr class="<?php echo $ticket->getPriority(); ?>">
          ...
          <td><?php if ($ticket->getAssignedTo()) { echo "<a href=\"".$ticket->getAssignedTo()->getCardUrl()."\">".clean($ticket->getAssignedTo()->getObjectName())."</a>"; } ?></td>
